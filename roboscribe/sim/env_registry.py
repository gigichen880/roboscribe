...
ENV_REGISTRY: dict[str, EnvInfo] = {
    ...
    "Door": EnvInfo(
        ...
        obs_keys=[
            ...
            "door_pos",
            "handle_pos",
            "hinge_qpos",           # door hinge angle
        ],
        goal_description="Open the door past a threshold angle",
        tips=(
            "Reach for the handle, grasp it, then pull to open the door. "
            "The handle position may need to be turned before pulling. "
            "This requires coordinated grasp + pull motion."
        ),
    ),
    "Wipe": EnvInfo(
        name="Wipe",
